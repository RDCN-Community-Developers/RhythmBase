...
/// </summary>
/// <typeparam name="TBeat">The type of beat. Must be a struct and implement <see cref="ITickTime{TBeat}"/>.</typeparam>
    ...
    where TBeat : struct, ITickTime<TBeat>
{
    ...
    ITickRange<TBeat> IntervalOf(TBeat beat1, TBeat beat2);
    /// <summary>
    ...
    ITickRange<TBeat> IntervalOf(TimeSpan timeSpan1, TimeSpan timeSpan2);
    /// <summary>
