...
public class ColorTrack : BaseTileEvent, ISingleEvent, IImageFileEvent
{
	...
	/// </summary>  
	[JsonAlias("trackColorAnimDuration")]
	...
	/// </summary>  
	[JsonCondition($"$&.{nameof(TrackStyle)} is RhythmBase.Adofai.{nameof(Adofai.TrackStyle)}.{nameof(TrackStyle.Standard)}")]
	...
	/// </summary>
	[JsonCondition($"$&.{nameof(FloorIconOutlines)} is not null")]
