...
namespace RhythmBase.Adofai.Utils;
    ...
    /// <summary>
    /// Creates an <see cref="TickTime"/> from the specified beat-only value.
    /// </summary>
    /// <param name="beatOnly">The beat-only value.</param>
    /// <returns>An <see cref="TickTime"/> representing the specified beat.</returns>
    ...
    /// <summary>
    /// Creates an <see cref="TickTime"/> from the specified time span.
    /// </summary>
    /// <param name="timeSpan">The time span.</param>
    /// <returns>An <see cref="TickTime"/> representing the specified time span.</returns>
    ...
    /// <returns>An <see cref="ITickRange{ADBeat}"/> representing the interval between the two beats.</returns>
    ...
    /// <returns>An <see cref="ITickRange{ADBeat}"/> representing the interval between the two time spans.</returns>
    public ITickRange<TickTime> IntervalOf(TimeSpan timeSpan1, TimeSpan timeSpan2)
    {
        throw new NotImplementedException();
    }

    void IBeatCalculator<TickTime>.Refresh()
    {
        Refresh();
    }
