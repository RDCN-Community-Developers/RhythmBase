		...
		) Right) baseData, EventTypeRegistryGenerationInfo[] registryGenerationInfos)> incrementalValueProvider)
	{
		context.RegisterSourceOutput(incrementalValueProvider, (context, data) =>
		{
			...
			#endif
			{
				...
				/// Construct an instance with specifying a <see cref="{{Calculator}}"/>.
				/// </summary>
				/// <param name="calculator">Specified calcu<see cref="{{Calculator}}"/>lator.</param>
				/// <param name="timeSpan">The total amount of time from the start of the <see cref="{{Chart}}"/> to the moment</param>
			...
			public partial class {{calculatorSymbol.Name}}
			{
				...
				/// <summary>
				/// Creates a <see cref="{{tickTimeSymbol.ContainingNamespace.ToDisplayString()}}.{{TickTimeRange}}"/> representing the interval between two ticks.
				/// </summary>
				...
				/// <summary>
				/// Creates a <see cref="{{tickTimeSymbol.ContainingNamespace.ToDisplayString()}}.{{TickTimeRange}}"/> representing the interval between two timespans.
				/// </summary>
